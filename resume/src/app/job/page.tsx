...
import { Search, Briefcase, MapPin, Link, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function JobScraper() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/resume/scrape`, {
        method: 'POST',
        headers: {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          {/* Title */}
          <h1 className="text-4xl font-extrabold text-gray-800 text-center">Job list</h1>
          <p className="text-lg text-center text-gray-600 mb-6">Find the latest job opportunities tailored to your preferences</p>

          {/* Scraping Form */}
          <Card className="shadow-lg rounded-lg bg-white p-8">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-bold text-gray-700">Search for Jobs</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="jobLocation" className="text-gray-700 font-medium">Job Location</Label>
                  <Input 
                    id="jobLocation" 
                    type="text" 
          ...
          {scrapedJobs.length > 0 && (
            <Card className="shadow-lg rounded-lg bg-white p-8">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-bold text-gray-700">Scraped Jobs</CardTitle>
              </CardHeader>
              <CardContent>
