...
export default function ResumeMatcher() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/resume/stats`, {
        method: "POST",
        headers: {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          {/* Title */}
          <h1 className="text-4xl font-extrabold text-gray-800 text-center">Update Resume</h1>
          <p className="text-lg text-center text-gray-600 mb-6">Update your resume</p>
          ...
          {resumeAnalysis && (
            <Card className="shadow-lg rounded-lg bg-white p-8">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-bold text-gray-700">Resume Analysis</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <h3 className="text-lg font-bold text-gray-700 mt-4">Weaknesses</h3>
                <ul className="list-disc list-inside">
          ...
          {skillProgresses && (
            <Card className="shadow-lg rounded-lg bg-white p-8">
              ...
              <CardContent>
                ...
                <p className="text-gray-500 mt-4">Evaluated At: {new Date(skillProgresses.evaluatedAt).toLocaleString()}</p>
              </CardContent>
            </Card>
          )}
        </div>
